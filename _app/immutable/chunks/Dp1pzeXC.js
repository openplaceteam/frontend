const y = "modulepreload",
    ...
    g = function (a, u, d) {
        ...
        if (u && u.length > 0) {
            ...
            h = s(
                u.map((e) => {
                    ...
                    if (((n.rel = r ? "stylesheet" : y), r || (n.as = "script"), (n.crossOrigin = ""), (n.href = e), v && n.setAttribute("nonce", v), document.head.appendChild(n), r))
                        return new Promise((i, c) => {
                            n.addEventListener("load", i), n.addEventListener("error", () => c(new Error(`Unable to preload CSS for ${e}`)));
                        });
                })
            );
        }
        ...
        return h.then((s) => {
            for (const t of s || []) t.status === "rejected" && m(t.reason);
            return a().catch(m);
        });
    };
export { g as _ };
