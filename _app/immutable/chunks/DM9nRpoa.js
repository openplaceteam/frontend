...
try {
    (function () {
        var t = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            e = new t.Error().stack;
        e && ((t._sentryDebugIds = t._sentryDebugIds || {}), (t._sentryDebugIds[e] = "94f605bd-8e96-4f8e-8769-0ddf701a4cfb"), (t._sentryDebugIdIdentifier = "sentry-dbid-94f605bd-8e96-4f8e-8769-0ddf701a4cfb"));
    })();
} catch {}
...
const h = { enable: qt, disable: Qt, isEnabled: Rt, log: Zt, warn: te, error: ee },
    Ot = 50,
    ne = "?",
    pt = /\(error: (.*)\)/,
...
function se(t) {
    ...
    return (
        ...
        e.reverse(),
        lt.test(w(e).function || "") && (e.pop(), lt.test(w(e).function || "") && e.pop()),
        e.slice(0, Ot).map((n) => ({ ...n, filename: n.filename || w(e).filename, function: n.function || ne }))
    );
}
function w(t) {
    return t[t.length - 1] || {};
...
function Un(t) {
    return t === null || ae(t) || (typeof t != "object" && typeof t != "function");
}
function Mt(t) {
    return x(t, "Object");
}
...
function le(t, e = {}) {
    ...
    try {
        ...
        for (; n && i++ < r && ((u = _e(n, f)), !(u === "html" || (i > 1 && o + s.length * a + u.length >= d))); ) s.push(u), (o += u.length), (n = n.parentNode);
...
function ge(t, e, n = !1) {
    return F(t) ? (fe(e) ? e.test(t) : F(e) ? (n ? t === e : t.includes(e)) : !1) : !1;
}
function zn(t, e = [], n = !1) {
...
function Pt(t) {
    if (oe(t)) return { message: t.message, name: t.name, stack: t.stack, ...gt(t) };
    if (ce(t)) {
        const e = { type: t.type, target: _t(t.target), currentTarget: _t(t.currentTarget), ...gt(t) };
...
function Te(t) {
    const e = ct(),
        n = { sid: T(), init: !0, timestamp: e, started: e, duration: 0, status: "ok", errors: 0, ignoreDuration: !1, toJSON: () => Ae(n) };
    return t && v(n, t), n;
}
function v(t, e = {}) {
    if (
        (e.user && (!t.ipAddress && e.user.ip_address && (t.ipAddress = e.user.ip_address), !t.did && !e.did && (t.did = e.user.id || e.user.email || e.user.username)),
...
class y {
    ...
    setUser(e) {
        return (this._user = e || { email: void 0, id: void 0, ip_address: void 0, username: void 0 }), this._session && v(this._session, { user: e }), this._notifyScopeListeners(), this;
    }
    getUser() {
        return this._user;
    }
    ...
    update(e) {
        ...
        const n = typeof e == "function" ? e(this) : e,
            ...
            { tags: s, extra: i, user: o, contexts: c, level: a, fingerprint: u = [], propagationContext: f } = r || {};
        return (
    ...
    addBreadcrumb(e, n) {
        ...
        if (r <= 0) return this;
        const s = { timestamp: at(), ...e, message: e.message ? $(e.message, 2048) : e.message };
        return (
            this._breadcrumbs.push(s),
            this._breadcrumbs.length > r && ((this._breadcrumbs = this._breadcrumbs.slice(-r)), (i = this._client) == null || i.recordDroppedEvent("buffer_overflow", "log_item")),
            this._notifyScopeListeners(),
            this
        );
    }
    ...
    captureException(e, n) {
        ...
        if (!this._client) return S && h.warn("No client configured on scope - will not capture exception!"), r;
    ...
    captureMessage(e, n, r) {
        ...
        if (!this._client) return S && h.warn("No client configured on scope - will not capture message!"), s;
        const i = new Error(e);
        return this._client.captureMessage(e, n, { originalException: e, syntheticException: i, ...r, event_id: s }, this), s;
    }
    captureEvent(e, n) {
        const r = (n == null ? void 0 : n.event_id) || T();
        return this._client ? (this._client.captureEvent(e, { ...n, event_id: r }, this), r) : (S && h.warn("No client configured on scope - will not capture event!"), r);
    }
...
function Me() {
    return { withIsolationScope: St, withScope: Oe, withSetScope: De, withSetIsolationScope: (t, e) => St(e), getCurrentScope: () => C().getScope(), getIsolationScope: () => C().getIsolationScope() };
}
function G(t) {
    const e = et(t);
...
function cr(t) {
    if (!t) return;
    const e = Object.entries(t).reduce((n, [r, s]) => (s && (n[`${vt}${r}`] = s), n), {});
    return ze(e);
}
function Ge(t) {
    ...
    if (Object.keys(t).length !== 0)
        return Object.entries(t).reduce((e, [n, r], s) => {
            const i = `${encodeURIComponent(n)}=${encodeURIComponent(r)}`,
                o = s === 0 ? i : `${e},${i}`;
            return o.length > Be ? (S && h.warn(`Not adding key: ${n} with val: ${r} to baggage header due to exceeding baggage size limits.`), e) : o;
        }, "");
}
const He = /^o(\d+)\./,
    Ye = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+)?)?@)([\w.-]+)(?::(\d+))?\/(.+)/;
...
function ur(t, e = !1) {
    const { host: n, path: r, pass: s, port: i, projectId: o, protocol: c, publicKey: a } = t;
...
function Ke(t) {
    ...
    return Gt({ host: i, pass: s, path: a, projectId: u, port: o, protocol: n, publicKey: r });
}
function Gt(t) {
...
function We(t) {
    ...
    return ["protocol", "publicKey", "host", "projectId"].find((o) => (t[o] ? !1 : (h.error(`Invalid Sentry Dsn: ${o} missing`), !0)))
        ? !1
        : n.match(/^\d+$/)
        ? Ve(r)
...
const qe = new RegExp("^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$");
function Qe(t) {
    if (!t) return;
    const e = t.match(qe);
    if (!e) return;
    let n;
    return e[3] === "1" ? (n = !0) : e[3] === "0" && (n = !1), { traceId: e[1], parentSampled: n, parentSpanId: e[2] };
}
function dr(t, e) {
    const n = Qe(t),
        r = Bt(e);
    if (!(n != null && n.traceId)) return { traceId: U(), sampleRand: Math.random() };
    const s = tn(n, r);
    r && (r.sample_rand = s.toString());
    const { traceId: i, parentSpanId: o, parentSampled: c } = n;
    return { traceId: i, parentSpanId: o, sampled: c, dsc: r || {}, sampleRand: s };
}
...
function lr(t) {
    const { spanId: e, traceId: n } = t.spanContext(),
        { data: r, op: s, parent_span_id: i, status: o, origin: c, links: a } = Y(t);
    return { parent_span_id: i, span_id: e, trace_id: n, data: r, op: s, status: o, origin: c, links: a };
}
function en(t) {
    const { spanId: e, traceId: n, isRemote: r } = t.spanContext(),
        s = r ? e : Y(t).parent_span_id,
        i = jt(t).scope,
        o = r ? (i == null ? void 0 : i.getPropagationContext().propagationSpanId) || ut() : e;
...
function nn(t) {
    if (t && t.length > 0) return t.map(({ context: { spanId: e, traceId: n, traceFlags: r, ...s }, attributes: i }) => ({ span_id: e, trace_id: n, sampled: r === zt, attributes: i, ...s }));
}
function Tt(t) {
    return typeof t == "number" ? It(t) : Array.isArray(t) ? t[0] + t[1] / 1e9 : t instanceof Date ? It(t.getTime()) : ct();
}
function It(t) {
...
function Y(t) {
    ...
    const { spanId: e, traceId: n } = t.spanContext();
    if (rn(t)) {
        const { attributes: s, startTime: i, name: o, endTime: c, status: a, links: u } = t,
            f = "parentSpanId" in t ? t.parentSpanId : "parentSpanContext" in t ? ((r = t.parentSpanContext) == null ? void 0 : r.spanId) : void 0;
        return { span_id: e, trace_id: n, data: s, description: o, parent_span_id: f, start_timestamp: Tt(i), timestamp: Tt(c) || void 0, status: on(a), op: s[Fe], origin: s[$e], links: nn(u) };
    }
...
function on(t) {
    if (!(!t || t.code === Ue)) return t.code === Ft ? "ok" : t.message || "unknown_error";
}
...
function Kt(t, e) {
    const n = e.getOptions(),
        ...
        s = { environment: n.environment || Yt, release: n.release, public_key: r, trace_id: t, org_id: Je(e) };
...
function cn(t) {
    ...
    return (
        ...
        an() && ((d.sampled = String(ft(n))), (d.sample_rand = (i == null ? void 0 : i.get("sentry.sample_rand")) ?? ((E = jt(n).scope) == null ? void 0 : E.getPropagationContext().sampleRand.toString()))),
        c(d),
...
class N {
    ...
    _executeHandlers() {
        ...
        (this._handlers = []),
            e.forEach((n) => {
                n[0] || (this._state === At && n[1](this._value), this._state === Ct && n[2](this._value), (n[0] = !0));
            });
    }
    _runExecutor(e) {
        const n = (i, o) => {
...
function tt(t, e, n, r = 0) {
    return new N((s, i) => {
        ...
        if (e === null || typeof o != "function") s(e);
            ...
            const c = o({ ...e }, n);
            S && o.id && c === null && h.log(`Event processor "${o.id}" dropped event`),
                it(c)
...
function Nt(t, e) {
    const { extra: n, tags: r, user: s, contexts: i, level: o, sdkProcessingMetadata: c, breadcrumbs: a, fingerprint: u, eventProcessors: f, attachments: d, propagationContext: l, transactionName: p, span: E } = e;
    P(t, "extra", n),
        P(t, "tags", r),
        P(t, "user", s),
        P(t, "contexts", i),
...
function yn(t, e) {
    (t.contexts = { trace: en(e), ...t.contexts }), (t.sdkProcessingMetadata = { dynamicSamplingContext: cn(e), ...t.sdkProcessingMetadata });
    const n = Ht(e),
        r = Y(n).description;
...
function Ar(t, e, n, r, s, i) {
    const { normalizeDepth: o = 3, normalizeMaxBreadth: c = 1e3 } = t,
        a = { ...e, event_id: e.event_id || n.event_id || T(), timestamp: e.timestamp || at() },
        u = n.integrations || t.integrations.map((m) => m.name);
    Tn(a, t), Cn(a, u), s && s.emit("applyFrameMetadata", e), e.type === void 0 && In(a, t.stackParser);
    ...
    return tt(E, a, n).then((m) => (m && An(m), typeof o == "number" && o > 0 ? Nn(m, o, c) : m));
}
function Tn(t, e) {
    const { environment: n, release: r, dist: s, maxValueLength: i = 250 } = e;
    (t.environment = t.environment || n || Yt), !t.release && r && (t.release = r), !t.dist && s && (t.dist = s);
    const o = t.request;
...
function Nn(t, e, n) {
    ...
    const r = {
        ...t,
        ...(t.breadcrumbs && { breadcrumbs: t.breadcrumbs.map((o) => ({ ...o, ...(o.data && { data: b(o.data, e, n) }) })) }),
        ...(t.user && { user: b(t.user, e, n) }),
        ...(t.contexts && { contexts: b(t.contexts, e, n) }),
        ...(t.extra && { extra: b(t.extra, e, n) }),
    };
    return (
        (s = t.contexts) != null && s.trace && r.contexts && ((r.contexts.trace = t.contexts.trace), t.contexts.trace.data && (r.contexts.trace.data = b(t.contexts.trace.data, e, n))),
        t.spans && (r.spans = t.spans.map((o) => ({ ...o, ...(o.data && { data: b(o.data, e, n) }) }))),
        (i = t.contexts) != null && i.flags && r.contexts && (r.contexts.flags = b(t.contexts.flags, 3, n)),
        r
    );
}
function xn(t, e) {
...
function Rn(t) {
    if (t) return On(t) ? { captureContext: t } : Mn(t) ? { captureContext: t } : t;
}
function On(t) {
    return t instanceof y || typeof t == "function";
}
const Dn = ["user", "level", "extra", "contexts", "tags", "fingerprint", "propagationContext"];
function Mn(t) {
...
function Or(t) {
    const e = z(),
        ...
        s = Te({ user: n.getUser() || e.getUser(), ...(r && { userAgent: r }), ...t }),
        i = e.getSession();
    return (i == null ? void 0 : i.status) === "ok" && v(i, { status: "exited" }), Wt(), e.setSession(s), s;
}
function Wt() {
    const t = z(),
