...
import "./ClL9a_Zs.js";
import { z as i, b as a } from "./iK5FT0Sa.js";
import { d as p } from "./Cw1VVyw7.js";
...
try {
  (function () {
    ...
    e &&
      ...
      (t._sentryDebugIds[e] = "27745d4f-ca95-44e0-9d66-9c719b508986"),
      (t._sentryDebugIdIdentifier =
        "sentry-dbid-27745d4f-ca95-44e0-9d66-9c719b508986"));
  })();
} catch {}
const _ = () => "Reported users",
  ...
  w = () => "Motivo do último timeout",
  te = (t = {}, e = {}) => ((e.locale ?? o()) === "en" ? I() : w()),
  v = () => "Reported by",
  D = () => "Denunciado por",
  ne = (t = {}, e = {}) => ((e.locale ?? o()) === "en" ? v() : D()),
  F = () => "Reason",
  T = () => "Motivo",
  ...
  Z = () => "User ID copied",
  z = () => "ID do usuário copiado",
  ae = (t = {}, e = {}) => ((e.locale ?? o()) === "en" ? Z() : z()),
  N = (t) => `Copy user ID: #${t.userId}`,
  U = (t) => `Copiar ID do usuário: #${t.userId}`,
  pe = (t, e = {}) => ((e.locale ?? o()) === "en" ? N(t) : U(t)),
