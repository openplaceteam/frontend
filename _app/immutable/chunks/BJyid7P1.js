  ...
  try {
    var q =
      typeof window < "u"
        ...
        ? self
        : {};
    q.SENTRY_RELEASE = { id: "0fdca126ca32380ac4e95a0011d2b66881dfb9e6" };
  } catch {}
})();
try {
  (function () {
    ...
    V &&
      ...
      (q._sentryDebugIds[V] = "0afbdf22-25b4-4f05-976b-45baef907ae6"),
      (q._sentryDebugIdIdentifier =
        "sentry-dbid-0afbdf22-25b4-4f05-976b-45baef907ae6"));
  })();
} catch {}
const r =
  ...
  E = "" + new URL("../assets/notification.CPyrWqU1.mp3", import.meta.url).href,
  M =
...
function d() {
  const q = {
    plop: new Audio(M),
    smallPlop: new Audio(l),
    bigPlop: new Audio(r),
    smallDropplet: new Audio(D),
    droppletAndPlop: new Audio(n),
    notification1: new Audio(E),
  };
...
let s;
function m(q) {
  return (s = q), a({ type: "previewPixels", data: q });
}
function p() {
  return (s = void 0), a({ type: "clearPixelPreview" });
}
function c(q) {
  return a({ type: "paintPixels", data: q });
}
async function G() {
  s || (await a({ type: "clearPixelPreview" }));
}
function a(q) {
  const V = Math.random(),
    e = { ...q, id: V };
  return new Promise((B, i) => {
    try {
      ...
      const t = (g) => {
        var A;
        ((A = g.data) == null ? void 0 : A.id) === V &&
          (B(void 0), o.removeEventListener("message", t));
      };
      ...
      w
        ...
        : navigator.serviceWorker.ready.then((g) => {
            ...
            A
              ...
              : i(new Error("Service worker registration not active"));
          });
    } catch (o) {
      i(o);
    }
...
function T({ pixel: q, season: V, tile: e }) {
  return `t=(${e[0]},${e[1]});p=(${q[0]},${q[1]});s=${V}`;
}
export { Y as A, c as a, p as c, T as g, m as p, G as s };
