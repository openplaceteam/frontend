import "../chunks/B2cHk4HI.js";
import { at as As, p as Ls, au as B, av as ze, y as Ps, g as e, aw as _, f as x, d as a, s as r, t as f, ax as Rs, b as v, c as zs, $ as Ss, r as t, ay as Ve, a as ue, u as ne, az as Bs, b4 as Se, n as Mt } from "../chunks/BDALf20I.js";
import { s } from "../chunks/4k6DpCgf.js";
import { i as h } from "../chunks/Bke_korE.js";
import { k as Ms } from "../chunks/BCONGQnO.js";
import { e as jt } from "../chunks/CZW2bcQi.js";
import { h as js } from "../chunks/BUhRjcOt.js";
import { r as $a, a as W, c as ka, s as xe } from "../chunks/BNZUboE0.js";
import { b as Da } from "../chunks/DS58drb5.js";
import { g as Es } from "../chunks/B4HM4TqG.js";
import { p as Ta } from "../chunks/C-Y7nmnD.js";
import { a as ge, t as oe, b as Cs, s as gr, u as Fs } from "../chunks/DffDvEhl.js";
import { D as Os, p as Gs, R as Vs, c as qs } from "../chunks/fZ59cmjx.js";
import { P as Et } from "../chunks/DCxPsWiR.js";
import { C as Ia, c as Hs, G as Ks, T as Qs } from "../chunks/ZzI7cLBE.js";
import { p as hr, L as yr, d as Ws } from "../chunks/sZ1mzRzK.js";
import { g as wr, h as Ur, n as $r, a as Ys, b as Zs, c as Js, t as Xs, d as en, l as tn, M as an, e as rn, r as sn, f as nn, m as on, i as dn, j as ln, u as cn, k as vn } from "../chunks/5mOJ66sL.js";
import { R as kr } from "../chunks/rLj4C5Bn.js";
import { g as j } from "../chunks/DklPLC_x.js";
import { r as Dr } from "../chunks/Drv8f_fG.js";
import { a as _n } from "../chunks/DdJK9GIy.js";
import { l as un } from "../chunks/BMfwGdZU.js";
import { n as Tr } from "../chunks/DFzO1c4b.js";
import { e as pn } from "../chunks/BpEsgMDn.js";
import { s as bn, l as mn } from "../chunks/6TAPgKgc.js";
import { g as Ct, a as fn } from "../chunks/ClOhzjRc.js";
(function () {
    try {
        var u = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {};
        u.SENTRY_RELEASE = { id: "35111e7039e8c68cc677344b7f7c6971567f6820" };
    } catch {}
})();
try {
    (function () {
        var u = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
            o = new u.Error().stack;
        o && ((u._sentryDebugIds = u._sentryDebugIds || {}), (u._sentryDebugIds[o] = "5a255a26-a4ab-45a5-87f0-f9268fbaca16"), (u._sentryDebugIdIdentifier = "sentry-dbid-5a255a26-a4ab-45a5-87f0-f9268fbaca16"));
    })();
} catch {}
const xn = () => "Search user",
    ...
    Ir = (u, o = Bs) => {
        ...
        t(c), f((V) => (y = W(c, 1, "badge badge-sm ml-0.5 font-semibold", null, y, V)), [() => ({ "badge-secondary": o() === "moderator" || o() == "global_moderator", "badge-warning": o() === "admin" })]), v(u, c);
    };
...
async function ho(u, o, c) {
    if (e(o))
        try {
            _(c, !0), await ge.removeBan(e(o).id), (e(o).ban_reason = null), oe.success("Ban removido");
        } catch (y) {
...
async function yo(u, o, c) {
    if (e(o))
        try {
            _(c, !0), await ge.removeTimeout(e(o).id), (e(o).timeout_until = null), oe.success("Timeout removido");
        } catch (y) {
...
var wo = x("<span><!></span>"),
    Uo = x('<div class="flex items-center gap-3"><span class="loading loading-spinner loading-sm"></span> <span> </span></div>'),
    ...
    jo = x('<tr><td> </td><td class="text-right"> </td><td> </td><td class="text-right"> </td></tr>'),
    ...
    Oo = x('<div class="rounded-box bg-base-100 border-base-300 border p-4 shadow"><h3 class="mb-3 text-lg font-semibold"> </h3> <!></div>'),
    Go = async (u, o, c, y) => {
    ...
    Ko = x('<div class="flex items-center justify-center py-6"><span class="loading loading-spinner loading-md"></span></div>'),
    Qo = (u, o, c) => {
        _(o, e(c), !0);
    },
    Wo = x("<span> </span>"),
    Yo = x('<div class="absolute bottom-3 right-3"><!></div>'),
    Zo = x('<button><!> <div class="flex flex-col text-start"><span><span> </span> <span> </span> <!></span> <div class="flex items-center gap-2"><span class="text-base-content/80 text-xs font-medium"> </span></div></div> <!></button>'),
    Jo = x('<div class="text-base-content/70 mt-4 text-center"> </div>'),
    Xo = async (u, o, c, y) => {
        (o[e(c)] += 1), await y(e(c));
    },
    ei = (u, o) => {
        navigator.clipboard.writeText(e(o).reportedUser.id.toString()), oe.success(cn());
    },
    ti = (u, o) => {
        navigator.clipboard.writeText(String(e(o))), oe.success(vn());
    },
    ai = x("<button> <!></button>"),
    ri = x('<span> <span class="font-semibold"> </span></span> <span> <span class="font-semibold"> </span></span>', 1),
    si = x('<span> <a target="_blank"><!> <span class="link">Link</span></a></span>'),
    ni = x('<span> <a target="_blank"><!> <span class="link">Link</span></a></span>'),
    oi = x('<div><h5 class="font-semibold"> </h5> <p class="text-base-content/80 text-sm"> </p></div>'),
    ii = x('<img class="border-base-content/20 mx-auto max-h-[70vh] w-max border" alt="Report location"/>'),
    di = x('<div class="grid grid-cols-1 items-center gap-2"><a class="relative h-max rounded-md" title="Report location" target="_blank"><!> <!></a></div>'),
    li = x('<div class="mt-2"><img class="border-base-content/20 mx-auto max-h-[70vh] w-max border" alt="Report image"/></div>'),
    ci = x(
    ...
    ui = x('<div class="text-base-content/70 flex h-full items-center justify-center"><!></div>'),
    pi = x(
...
function Oi(u, o) {
    ...
    function La(n) {
        return { id: n.id, name: n.name ?? `#${n.id}`, picture: n.picture ?? void 0, allianceId: 0, allianceName: "", equippedFlag: 0 };
    }
    Ps(() => {
        const n = Ta.url.searchParams.get("id"),
            b = n ? Number(n) : null;
        b !== e(y) && (_(y, b, !0), n && _(c, n, !0)), e(y) != null && !isNaN(e(y)) ? Ra() : (_(l, null), _(Y, null));
    });
    function Pa(n) {
        if (!n) return "—";
        const b = new Date(n);
    ...
    async function qe(n, b = !1) {
        if (e(l))
            try {
                _(Me, !0), b && ((Vt[n] = 0), _(De, [], !0), _(Te, void 0), Je.delete(n));
                const g = Vt[n],
    ...
    async function Ra() {
        ...
        try {
            ...
            n.timeout_until && !Ht(n.timeout_until) && (n.timeout_until = null), _(l, n, !0), Sr(), _(Ft, 0);
            try {
                const b = await ge.getUserPurchases(n.id);
                _(
                    Be,
                    b.sort((g, H) => new Date(H.createdAt).getTime() - new Date(g.createdAt).getTime()),
                    !0
                );
            } catch (b) {
    ...
    function Br() {
        ...
        const n = ["id", "product_name", "price", "amount", "createdAt"].join(","),
            b = e(Be).map((ie) => [ie.id, ie.product_name, ie.price, ie.amount, ie.createdAt].join(",")),
            g = [n, ...b].join(`
`),
            H = new Blob([g], { type: "text/csv;charset=utf-8;" }),
            Z = URL.createObjectURL(H),
            te = document.createElement("a");
        (te.href = Z), (te.download = `purchases_user_${((ae = e(l)) == null ? void 0 : ae.id) ?? "unknown"}.csv`), te.click(), URL.revokeObjectURL(Z);
    }
    var Kt = bi();
    js((n) => {
                                ...
                                var et = (Ie) => {
                                        ...
                                        t(de),
                                            f((we) => s(ye, we), [
                                                () => {
                                                    var we;
                                                    return ((we = Tr) == null ? void 0 : we()) ?? "No user selected";
                                                },
                                            ]),
                                            v(Ie, de);
                                    },
                                    wt = (Ie) => {
                                            ...
                                            lt = a(Ee);
                                        {
                                            var ta = (T) => {
                                                    var I = Io(),
                                                        J = a(I);
                                                    t(I), f(() => s(J, `BANNED${e(l).ban_reason ? ` (${e(l).ban_reason})` : ""}`)), v(T, I);
                                                },
                                                It = (T) => {
                                                    var I = Ve(),
                                                        J = ue(I);
                                                    {
                                                        var Ae = (le) => {
                                                                var re = No(),
                                                                    Ue = a(re);
                                                                t(re), f((_t) => s(Ue, `TIMEOUT until ${_t ?? ""}`), [() => Pa(e(l).timeout_until)]), v(le, re);
                                                            },
                                                            Le = (le) => {
                                                                var re = Ao();
                                                                v(le, re);
                                            ...
                                            var ct = (T) => {
                                                    ...
                                                    J = ue(I);
                                                {
                                                    var Ae = (re) => {
                                                        ...
                                                        var _t = a(Ue);
                                                        Qs(_t, { class: "size-4" }), Mt(), t(Ue), f(() => (Ue.disabled = e(z))), v(re, Ue);
                                                    };
                                                    h(J, (re) => {
                                                ...
                                                var le = a(Le);
                                                Ks(le, { class: "size-4" }), Mt(), t(Le), f(() => (Le.disabled = e(z))), v(T, I);
                                            };
                                            h(Nt, (T) => {
                                                var I;
                                                ((I = Fs.data) == null ? void 0 : I.id) !== e(l).id && !e(l).ban_reason && T(ct);
                                            });
                                        }
                                        var Ce = r(Nt, 2);
                                        Ce.__click = [yo, l, z];
                                        ...
                                        (vt.__click = [ho, l, z]),
                                            ...
                                            f(
                                                (T) => {
                                                    s(rt, e(l).name), s(Ut, `#${e(l).id ?? ""}`), s($t, ` ${T ?? ""} ID`), s(kt, e(l).alliance_name ?? "—"), s(Dt, e(l).role), (Ce.disabled = e(z)), (vt.disabled = e(z));
                                                },
                                                [() => qs()]
                                            ),
                                            v(Ie, de);
    ...
    var Ea = r(Jt, 2);
    {
        var Gr = (n) => {
            ...
            jt(
                ...
                (d, i) => {
                    ...
                    t(M),
                        ...
                        f(
                            (K) => {
                                s($, `${e(i).author.name ?? ""} #${e(i).author.id ?? ""} `), s(w, e(i).author.role), s(F, K), s(X, e(i).note);
                            },
            ...
            jt(
                ...
                (d, i) => {
                    ...
                    t(F),
                        ...
                        f(
                            (X, K) => {
                                s(p, e(i).product_name), s(k, `US$ ${X ?? ""}`), s(N, e(i).amount), s(M, K);
                            },
                        ...
                        var $ = (w) => {
                            ...
                            k = (w) => {
                                ...
                                t(Rt),
                                    ...
                                    f(
                                        (ma, zt, mt) => {
                                            s(X, e(P).closedTotal), s(ce, `${e(P).bans ?? ""} `), s(Fe, `(${ma ?? ""})`), s(R, `${e(P).ignored ?? ""} `), s(Pe, `(${zt ?? ""})`), s(Pt, `${e(P).timeouts ?? ""} `), s(ba, `(${mt ?? ""})`);
                                        },
                                        [() => qt(e(P).bans, e(P).closedTotal), () => qt(e(P).ignored, e(P).closedTotal), () => qt(e(P).timeouts, e(P).closedTotal)]
                                    ),
                                    v(w, N);
                            };
                        h(p, (w) => {
            ...
            jt(
                ...
                (d, i) => {
                    ...
                    var K = r(M, 2);
                    {
                        var $e = (R) => {
                            ...
                            t(E),
                                f(
                                    (Ze) => {
                                        (Pe = W(E, 1, "badge badge-xs font-semibold", null, Pe, Ze)), s(be, e(i).status);
                                    },
                                    [() => ({ "badge-ghost": e(i).status === "open" || e(i).status === "ignore", "badge-warning": e(i).status === "timeout", "badge-error": e(i).status === "ban" })]
                                ),
                                v(R, E);
                        };
                        h(K, (R) => {
                    ...
                    t(p),
                        f(
                            (R, E) => {
                                W(p, 1, ka({ "bg-base-100 ring-primary relative flex gap-2 rounded-2xl p-3 shadow": !0, "bg-primary/10 ring-2": e(D) })),
                        ...
                        Ms(
                            ...
                            (D) => {
                                const p = ne(() => e(Te)),
                                    $ = ne(() => {
                                        var A;
                                        return ((A = on(e(p).reports, (m) => m.sameIpAccounts ?? 0)) == null ? void 0 : A.sameIpAccounts) ?? 0;
                                    });
                                var k = vi(),
                                    w = ue(k),
                                    N = a(w),
                                ...
                                var Pt = r(be, 2);
                                {
                                    var Rt = (A) => {
                                        ...
                                        Ia(me, { class: "size-3" }),
                                            ...
                                            f(
                                                (ke, Re, fe) => {
                                                    W(G, 1, `tooltip badge badge-sm ml-0.5 border-0 ${ke ?? ""} ${Re ?? ""}`), xe(G, "title", fe), s(_e, `${e(p).reportedUser.allianceName ?? "—" ?? ""} `);
                                                },
                                                [() => fn(e(m)), () => Ct(e(m)), () => Hs({ allianceId: e(m) })]
                                            ),
                                            v(A, G);
                                    };
                                    h(Pt, (A) => {
                                ...
                                var sr = r(mt, 2);
                                {
                                    var ms = (A) => {
                                        ...
                                        t(Oe),
                                            ...
                                            f(
                                                (ft, Bt) => {
                                                    s(_e, `${ft ?? ""}: `), s(ke, e(p).reportedUser.timeoutCount ?? 0), s(fe, `${Bt ?? ""}: `), s(St, gr[e(p).reportedUser.lastTimeoutReason] ?? e(p).reportedUser.lastTimeoutReason);
                                                },
                                                [() => dn(), () => ln()]
                                            ),
                                            v(A, m);
                                ...
                                jt(
                                    ...
                                    (A) => A.id,
                                    (A, m) => {
                                        const G = ne(() => e(m).reportedLatitude != null && e(m).reportedLongitude != null),
                                            _e = ne(() => (e(G) ? `${Ta.url.origin}/?lat=${e(m).reportedLatitude}&lng=${e(m).reportedLongitude}&select=true${e(m).zoom ? `&zoom=${e(m).zoom}` : ""}` : null));
                                        var me = ci(),
                                            ke = a(me),
                                            Re = a(ke);
                                        t(ke);
                                        ...
                                        var $s = r(mr, 2);
                                        {
                                            var ks = (L) => {
                                                ...
                                                yr(Q, { class: "inline size-4" }),
                                                    ...
                                                    f(
                                                        (ee) => {
                                                            s(C, `${ee ?? ""}: `), xe(O, "href", `${Ta.url.origin}/?lat=${e(m).lastPixelLatitude}&lng=${e(m).lastPixelLongitude}&select=true`);
                                                        },
                                                        [() => tn()]
                                                    ),
                                                    v(L, S);
                                            ...
                                            h($s, (L) => {
                                                e(m).lastPixelLatitude != null && e(m).lastPixelLongitude != null && L(ks);
                                            });
                                        }
                                        t(_r), t(St), t(fe);
                                        var fr = r(fe, 2);
                                        ...
                                        var Ts = r(fr, 2);
                                        {
                                            var Is = (L) => {
                                                    ...
                                                    var ee = r(O, 2);
                                                    an(ee, { class: "absolute left-1/2 top-1/2 size-7 -translate-x-1/2 -translate-y-[87%]" }), t(C), t(S), f(() => xe(C, "href", e(_e))), v(L, S);
                                                },
                                                Ns = (L) => {
                                                    var S = Ve(),
                                                        C = ue(S);
                                                    {
                                                        var O = (Q) => {
                                                            var ee = li(),
                                                                Ge = a(ee);
                                                            t(ee), f(() => xe(Ge, "src", e(m).imageUrl)), v(Q, ee);
                                                        };
                                                        h(
                                                            C,
                                                            (Q) => {
                                        ...
                                        t(me),
                                            f(
                                                ...
                                                [() => Ys(), () => Zs(), () => Ct(e(m).reportedBy), () => Js(), () => Xs(), () => new Date(e(m).createdAt).toLocaleString()]
                                            ),
                                            v(A, me);
                                    }
                                ),
            ...
            t(tr),
                ...
                t(Qa),
                f(
                    (d, i, U, D, p, $, k, w, N, F, M, X, K, $e, ce, ve, Fe, se, pe, R) => {
                        s(te, d),
                            ...
                            s(ea, D),
                            s(Tt, e(l).email),
                            W(lt, 1, ka(e(l).phone_validated ? "text-success" : "text-error")),
                            ...
                            s(Zr, $e),
                            s(ts, ce),
                            W(ut, 1, `tab transition-all ${e(q) === "received" ? "tab-active !bg-primary !text-primary-content !border-primary/60 btn btn-primary btn-sm scale-[1.02] !border !shadow-md" : "hover:brightness-105"}`),
                            s(as, ve),
                            W(pt, 1, `tab transition-all ${e(q) === "sent" ? "tab-active !bg-primary !text-primary-content !border-primary/60 btn btn-primary btn-sm scale-[1.02] !border !shadow-md" : "hover:brightness-105"}`),
                            s(rs, Fe),
                            W(At, 1, `tab transition-all ${e(q) === "handled" ? "tab-active !bg-primary !text-primary-content !border-primary/60 btn btn-primary btn-sm scale-[1.02] !border !shadow-md" : "hover:brightness-105"}`),
                            s(ss, se),
                            (bt.disabled = e(Me)),
                            xe(bt, "title", pe),
                            (Lt.disabled = e(Me)),
    ...
    t(Kt),
        f(
            (n, b, g) => {
                s(Mr, n), (Xe.disabled = e(z)), s(jr, b), (yt.disabled = e(z)), s(Er, ` ${g ?? ""}`);
            },
            [
